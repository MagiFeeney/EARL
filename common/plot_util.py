...
from stable_baselines3.common.logger import read_json, read_csv
...
def load_results(root_dir_or_dirs, enable_progress=True, enable_monitor=True, verbose=False, multiple=False):
    '''
